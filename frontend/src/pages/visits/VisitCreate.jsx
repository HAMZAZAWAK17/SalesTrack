...
export default function VisitCreate() {
  ...
  useEffect(() => {
    async function loadClients() {
      try {
        ...
        setToast({ open: true, message: 'Impossible de charger la liste des clients.', severity: 'error' });
      } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        setToast({ open: true, message: 'Rapport de visite enregistré !', severity: 'success' });
      ...
      setToast({ open: true, message: err.message || 'Erreur lors de l\'enregistrement.', severity: 'error' });
    } finally {
      setSubmitting(false);
    }
  };
